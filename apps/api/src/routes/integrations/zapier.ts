// @ts-nocheck
// TODO: zapier integration is out of date — references columns that no longer
// exist on the apiKeys schema (key, isRevoked, userId), uses repos.links which
// doesn't exist on D1Repositories, and sets untyped Hono context vars. The
// route is exposed at /api/integrations/zapier but is not part of the agentic
// launch surface. Rewrite or delete in a dedicated cleanup pass before relying
// on it in production.
