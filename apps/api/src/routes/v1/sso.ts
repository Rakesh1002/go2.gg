...
// All SSO routes require an authenticated session (or API key). Without
// this, c.get("user") is undefined and every handler short-circuited to
// 403 "Organization required".
sso.use("/*", apiKeyAuthMiddleware());
