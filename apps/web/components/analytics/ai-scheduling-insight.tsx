...
export function AISchedulingInsight() {
  ...
  return (
    <Card className="relative overflow-hidden border-border/50 bg-gradient-to-r from-muted/30 to-muted/10">
      {/* Subtle accent line */}
      <div className="absolute top-0 right-0 left-0 h-0.5 bg-gradient-to-r from-primary/50 via-primary/30 to-transparent" />
      ...
      <CardContent className="p-4 sm:p-6">
        <div className="flex items-start justify-between gap-4">
          ...
          {/* Right section - Stats */}
          <div className="hidden min-w-[200px] flex-col gap-2 text-sm sm:flex">
        ...
        {/* Mobile stats */}
        <div className="mt-4 flex items-center gap-4 border-t pt-3 text-muted-foreground text-xs sm:hidden">
