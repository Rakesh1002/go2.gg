    ...
    <div className={cn("space-y-4", className)}>
      ...
      <div className="mx-auto max-w-[280px]">
        <div className="overflow-hidden rounded-3xl border-4 border-gray-800 bg-gray-100 shadow-xl">
          ...
          <div className="min-h-[200px] bg-white p-4">
            ...
            <p className="mt-1 text-gray-400 text-xs">Just now</p>
          </div>
        </div>
      </div>
      ...
      <div className="space-y-3 rounded-lg border bg-muted/30 p-4">
        <div className="flex items-center justify-between">
          <span className="font-medium text-sm">Character Count</span>
          <span className="font-mono text-sm">{analysis.totalChars}</span>
        </div>

        <div className="flex items-center justify-between">
          <span className="font-medium text-sm">SMS Segments</span>
          <span className={cn("font-bold font-mono text-sm", segmentColor)}>
            {analysis.segments}
          </span>
        </div>

        <div className="flex items-center justify-between">
          <span className="font-medium text-sm">Remaining in Segment</span>
          <span className="font-mono text-sm">{analysis.remaining}</span>
        </div>

        <div className="flex items-center justify-between">
          <span className="font-medium text-sm">Encoding</span>
        ...
        <div className="border-t pt-3">
          ...
          <p className="mt-1 text-muted-foreground text-xs">Based on average US carrier rates</p>
        </div>
      </div>
