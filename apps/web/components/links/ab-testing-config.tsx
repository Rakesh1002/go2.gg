    ...
    <div className={cn("space-y-4", className)}>
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-2">
          ...
          <Label className="font-medium text-sm">A/B Test Variants</Label>
        </div>
        <Button
          type="button"
          variant="outline"
      ...
      <div className="space-y-3">
        {variants.map((variant, index) => (
          <div key={variant.id} className="flex items-center gap-3 rounded-lg border bg-card p-3">
            <div
              className={cn(
            ...
            <div className="flex-1 space-y-2">
              ...
              />
              <div className="flex items-center gap-2">
                <span className="w-8 text-muted-foreground text-xs">10%</span>
                <Slider
                  ...
                  className="flex-1"
                />
                <span className="w-8 text-muted-foreground text-xs">90%</span>
              </div>
            </div>
            {variants.length > 2 && (
              <Button
      ...
      <CardContent className="space-y-4">
        <div className="flex items-center gap-4 rounded-lg bg-muted/50 p-4">
          ...
          <div className="flex-1">
            <p className="font-medium text-sm">Upgrade to unlock A/B testing</p>
            <p className="text-muted-foreground text-xs">
