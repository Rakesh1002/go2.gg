      ...
      <Tabs value={activeTab} onValueChange={setActiveTab}>
        ...
        <TabsContent value="geo" className="space-y-4 pt-4">
          <div className="flex items-center justify-between">
            <div>
              <Label className="font-medium text-sm">Geographic Targeting</Label>
              <p className="text-muted-foreground text-xs">Redirect users based on their country</p>
            </div>
            <Button
              type="button"
              variant="outline"
        ...
        <TabsContent value="device" className="space-y-4 pt-4">
          <div>
            <Label className="font-medium text-sm">Device Targeting</Label>
        ...
        <TabsContent value="deeplinks" className="space-y-4 pt-4">
          <div>
            <Label className="font-medium text-sm">App Deep Links</Label>
            <p className="text-muted-foreground text-xs">
            ...
            <div className="flex items-center gap-3 rounded-lg border bg-card p-3">
              ...
              <div className="flex-1">
                ...
                <Input
                  ...
                  className="mt-1"
                />
                <p className="mt-1 text-muted-foreground text-xs">Play Store URL or intent URL</p>
              </div>
            </div>
          </div>
        </TabsContent>
    ...
    <Card className="border-dashed">
      ...
      <CardContent className="space-y-4">
        <div className="flex items-center gap-4 rounded-lg bg-muted/50 p-4">
          ...
          <div className="flex-1">
            <p className="font-medium text-sm">Upgrade to unlock targeting</p>
            <p className="text-muted-foreground text-xs">
