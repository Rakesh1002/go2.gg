    ...
    return (
      ...
      >
        <Avatar className="h-14 w-14 border-2 border-[var(--marketing-accent)]/20">
          ...
          <AvatarFallback className="bg-[var(--marketing-accent)]/10 font-semibold text-[var(--marketing-accent)]">
            {initials}
          </AvatarFallback>
        </Avatar>
        <div className="flex-1">
          ...
          {authorBio && (
            <p className="mt-1 line-clamp-2 text-[var(--marketing-text-muted)] text-sm">
              {authorBio}
            </p>
          )}
          <div className="mt-3 flex items-center gap-4 text-[var(--marketing-text-muted)] text-sm">
  ...
  return (
    <div className={cn("flex items-center gap-4", className)}>
      <Avatar className="h-10 w-10 border border-[var(--marketing-border)]">
        <AvatarImage src={authorImage} alt={author} />
        <AvatarFallback className="bg-[var(--marketing-accent)]/10 font-semibold text-[var(--marketing-accent)] text-sm">
          {initials}
        </AvatarFallback>
      </Avatar>
      <div className="flex flex-col sm:flex-row sm:items-center sm:gap-4">
        <p className="font-medium text-[var(--marketing-text)]">{author}</p>
        <div className="flex items-center gap-3 text-[var(--marketing-text-muted)] text-sm">
          <div className="flex items-center gap-1.5">
