...
export function OrgSwitcher() {
  ...
  // Always render the popover — even single-org users get one-click access to
  // workspace shortcuts (Settings, Team, Billing, Create org). Matches Linear /
  // Vercel / Notion / Stripe; before this we used to render a static label
  // for single-org users which made the pill look broken.
  return (
