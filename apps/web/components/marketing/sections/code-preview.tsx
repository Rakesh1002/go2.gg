...
export function CodePreview() {
  return (
    <section className="mx-auto max-w-7xl bg-[var(--marketing-bg)] px-4 py-16 sm:px-6 md:py-24 lg:px-8">
          ...
          {Object.entries(codeExamples).map(([key, code]) => (
            <TabsContent key={key} value={key} className="mt-4">
              <div className="overflow-hidden rounded-lg border border-code-border bg-code-bg">
                <div className="flex items-center gap-2 border-code-border border-b px-4 py-2">
                  ...
                  <span className="ml-2 text-code-text/60 text-xs">
