    ...
    return (
      <div className="space-y-4 rounded-xl border bg-card p-6 shadow-lg">
        ...
        <div className="text-center">
          <div className="mb-3 inline-flex items-center gap-2 rounded-full bg-success/10 px-3 py-1 text-sm text-success">
        ...
        {isAuthenticatedLink ? (
          ...
          <div className="rounded-lg border border-success/50 border-dashed bg-success/5 p-4">
          ...
          <div className="rounded-lg border border-warning/50 border-dashed bg-warning/5 p-4">
            <div className="flex items-start gap-3">
    ...
    >
      <div className="flex flex-col gap-3 sm:flex-row">
        <div className="relative flex-1">
          <Link2 className="-translate-y-1/2 absolute top-1/2 left-4 h-5 w-5 text-muted-foreground" />
          <Input
            type="text"
            placeholder="Paste your long URL here..."
            value={url}
            onChange={(e) => setUrl(e.target.value)}
            className="h-14 rounded-xl border-0 bg-muted/50 pl-12 text-lg focus-visible:ring-2 focus-visible:ring-primary/50"
          />
        </div>
        <Button
          type="submit"
          size="xl"
          className="gap-2 shadow-lg shadow-primary/25 hover:shadow-primary/30 hover:shadow-xl"
          disabled={loading}
        >
          {loading ? (
