...
import { normalizePlan } from "./plan-capabilities";
...
export function canAccessFeature(
  userPlan: PlanId | string | undefined | null,
  feature: Feature
): boolean {
  const requiredPlan = featureInfo[feature].requiredPlan;
  return planHierarchy[normalizePlan(userPlan)] >= planHierarchy[requiredPlan];
}
