      ...
      <section className="border-[var(--marketing-border)] border-t bg-[var(--marketing-bg-elevated)]/30">
        <div className="mx-auto max-w-7xl px-4 py-16 md:py-24">
          ...
          <div className="grid gap-6 md:grid-cols-3">
            <div className="rounded-xl border border-[var(--marketing-border)] bg-[var(--marketing-bg-elevated)] p-6 transition-colors hover:border-[var(--marketing-accent)]/30">
              <div className="mb-4 flex h-12 w-12 items-center justify-center rounded-lg bg-[var(--marketing-accent)]/10">
                <svg
              ...
              <h3 className="mb-2 font-semibold text-[var(--marketing-text)]">100% Free</h3>
