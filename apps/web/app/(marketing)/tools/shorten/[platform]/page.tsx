...
> = {
  youtube: {
    name: "YouTube",
    title: "YouTube URL Shortener | Shorten YouTube Links",
    description:
  ...
  twitter: {
    name: "Twitter/X",
    title: "Twitter URL Shortener | Shorten Links for X",
    description:
  ...
  tiktok: {
    name: "TikTok",
    title: "TikTok URL Shortener | Links for TikTok Bio",
    description:
  ...
  instagram: {
    name: "Instagram",
    title: "Instagram Bio Link Shortener | Links for IG",
    description:
  ...
  amazon: {
    name: "Amazon",
    title: "Amazon Affiliate Link Shortener | Track Amazon Links",
    description:
  ...
  spotify: {
    name: "Spotify",
    title: "Spotify URL Shortener | Share Music Links",
    description:
...
export default async function PlatformShortenPage({ params }: Props) {
  ...
  return (
    <div className="max-w-7xl py-12">
      ...
      {/* Benefits */}
      <div className="mb-16">
        <h2 className="mb-8 text-center font-bold text-3xl">Why Shorten {config.name} Links?</h2>
      ...
      <div className="mb-16">
        ...
        <div className="mx-auto grid max-w-4xl gap-4 md:grid-cols-2 lg:grid-cols-3">
          {config.useCases.map((useCase) => (
            <div key={useCase} className="rounded-lg bg-muted/50 p-4 text-center">
              {useCase}
            </div>
          ))}
        </div>
      ...
      {/* Other Platforms */}
      <div className="mb-16">
        <h2 className="mb-6 text-center font-bold text-2xl">URL Shorteners for Other Platforms</h2>
      ...
      <div className="rounded-lg bg-muted p-8 text-center">
        <h2 className="mb-4 font-bold text-2xl">Ready to shorten your {config.name} links?</h2>
