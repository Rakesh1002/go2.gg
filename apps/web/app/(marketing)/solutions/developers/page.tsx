...
const devStats = [
  ...
  { value: "AGPL-3.0", label: "License", description: "Fully open source" },
...
const devFaqs = [
  ...
  },
  {
    ...
    answer:
      "Yes. Go2 is AGPL-3.0 licensed (with a commercial license available for proprietary use). View the source, contribute PRs, or self-host on your own infrastructure.",
  },
  {
