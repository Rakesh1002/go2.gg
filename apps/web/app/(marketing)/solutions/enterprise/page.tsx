...
const useCases = [
  ...
  },
  {
    ...
    description:
      "AGPL-3.0 licensed (commercial license available). Deploy on your own infrastructure. Full source code access. No vendor lock-in.",
  },
];
...
const benefits = [
  ...
  "Self-hosting option (AGPL-3.0, commercial license available)",
...
const enterpriseFaqs = [
  ...
  },
  {
    ...
    answer:
      "Yes. Go2 is AGPL-3.0 licensed (with a commercial license available for proprietary use). Deploy on your own infrastructure for complete data control. We provide support for self-hosted deployments.",
  },
];
