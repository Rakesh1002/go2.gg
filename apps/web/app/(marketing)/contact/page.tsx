      ...
      <div className="relative mx-auto max-w-7xl px-4 py-20 md:py-32">
        ...
        <div className="mx-auto mt-20 grid max-w-6xl gap-16 lg:grid-cols-12 lg:items-start">
              ...
              <div className="group flex items-start gap-4">
                ...
                <div>
                  ...
                  <a
                    ...
                    className="text-[var(--marketing-text-muted)] transition-colors hover:text-[var(--marketing-accent)]"
                  >
                    {siteConfig.email}
                  </a>
                </div>
          ...
          <div className="lg:col-span-8">
            <div className="rounded-3xl border border-[var(--marketing-border)] bg-[var(--marketing-bg-elevated)] p-8 shadow-[var(--marketing-accent)]/5 shadow-xl md:p-10">
              <ContactForm />
            </div>
          </div>
        </div>
