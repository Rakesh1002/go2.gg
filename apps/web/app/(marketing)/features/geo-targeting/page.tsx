  ...
  return (
    <div className="p-6 md:p-8">
      ...
      <div className="mx-auto max-w-md">
        {/* Main Link */}
        <div className="mb-6 rounded-xl border border-[var(--marketing-accent)]/30 bg-[var(--marketing-accent)]/10 p-4 text-center">
          <div className="mb-1 text-[var(--marketing-text-muted)] text-sm">Your smart link</div>
          <div className="font-mono font-semibold text-[var(--marketing-accent)] text-lg">
            go2.gg/app
          </div>
        </div>
        ...
        <div className="space-y-3">
          <div className="flex items-center gap-3 rounded-lg border border-[var(--marketing-border)] bg-[var(--marketing-bg)] p-3">
            ...
            <div className="flex-1">
              <div className="font-medium text-[var(--marketing-text)] text-sm">iOS Users</div>
              <div className="text-[var(--marketing-text-muted)] text-xs">→ apps.apple.com/app</div>
            </div>
          </div>
          ...
          <div className="flex items-center gap-3 rounded-lg border border-[var(--marketing-border)] bg-[var(--marketing-bg)] p-3">
            ...
            <div className="flex-1">
              <div className="font-medium text-[var(--marketing-text)] text-sm">Android Users</div>
          ...
          <div className="flex items-center gap-3 rounded-lg border border-[var(--marketing-border)] bg-[var(--marketing-bg)] p-3">
            ...
            <div className="flex-1">
              <div className="font-medium text-[var(--marketing-text)] text-sm">EU Visitors</div>
              <div className="text-[var(--marketing-text-muted)] text-xs">→ eu.example.com</div>
            </div>
          </div>

          <div className="flex items-center gap-3 rounded-lg border border-[var(--marketing-border)] bg-[var(--marketing-bg)] p-3 opacity-60">
            <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-gray-100 dark:bg-gray-800">
            ...
            <div className="flex-1">
              ...
              <div className="text-[var(--marketing-text-muted)] text-xs">→ example.com</div>
            </div>
          </div>
        </div>
      </div>
