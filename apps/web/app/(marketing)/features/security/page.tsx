  ...
  return (
    <div className="p-6 md:p-8">
      <div className="mb-8 text-center">
        ...
        <p className="text-[var(--marketing-text-muted)] text-sm">Enterprise-grade protection</p>
      </div>
      ...
      <div className="mx-auto max-w-lg space-y-4">
        ...
        <div className="rounded-xl border border-[var(--marketing-border)] bg-[var(--marketing-bg)] p-6">
          ...
          <div className="grid grid-cols-3 gap-4">
            <div className="flex flex-col items-center rounded-lg border border-[var(--marketing-border)] bg-[var(--marketing-bg-elevated)] p-4">
              <Shield className="mb-2 h-8 w-8 text-[var(--marketing-accent)]" />
              <span className="font-semibold text-[var(--marketing-text)] text-sm">SOC2</span>
              <span className="text-[var(--marketing-text-muted)] text-xs">Type II</span>
            </div>
            <div className="flex flex-col items-center rounded-lg border border-[var(--marketing-border)] bg-[var(--marketing-bg-elevated)] p-4">
              <Lock className="mb-2 h-8 w-8 text-[var(--marketing-accent)]" />
              <span className="font-semibold text-[var(--marketing-text)] text-sm">GDPR</span>
              <span className="text-[var(--marketing-text-muted)] text-xs">Compliant</span>
            </div>
            <div className="flex flex-col items-center rounded-lg border border-[var(--marketing-border)] bg-[var(--marketing-bg-elevated)] p-4">
              <FileCheck className="mb-2 h-8 w-8 text-[var(--marketing-accent)]" />
              <span className="font-semibold text-[var(--marketing-text)] text-sm">CCPA</span>
              <span className="text-[var(--marketing-text-muted)] text-xs">Compliant</span>
            </div>
          </div>
        </div>
        ...
        <div className="rounded-xl border border-[var(--marketing-border)] bg-[var(--marketing-bg)] p-6">
          ...
          <div className="space-y-3">
            <div className="flex items-center gap-3 rounded-lg bg-[var(--marketing-bg-elevated)] p-3">
              <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-green-500/10">
                <Lock className="h-4 w-4 text-green-500" />
              </div>
              <div className="flex-1">
                <div className="font-medium text-[var(--marketing-text)] text-sm">Encryption</div>
                <div className="text-[var(--marketing-text-muted)] text-xs">
                  TLS 1.3 in transit, AES-256 at rest
                </div>
              </div>
              <div className="font-medium text-green-500 text-xs">Active</div>
            </div>
            ...
            <div className="flex items-center gap-3 rounded-lg bg-[var(--marketing-bg-elevated)] p-3">
              ...
              <div className="flex-1">
                ...
                <div className="text-[var(--marketing-text-muted)] text-xs">90-day retention</div>
              </div>
              <div className="font-medium text-green-500 text-xs">Active</div>
            </div>
          </div>
