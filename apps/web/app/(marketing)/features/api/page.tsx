...
import { Zap, Shield, Book, Webhook, Terminal, Key } from "lucide-react";
...
function CodeDemo() {
  return (
    <div className="mx-auto w-full max-w-2xl overflow-hidden rounded-xl border border-gray-800 bg-[#0d1117] text-left font-mono text-sm shadow-2xl">
      <div className="flex items-center gap-2 border-gray-800 border-b bg-[#161b22] px-4 py-3">
        <div className="h-3 w-3 rounded-full bg-red-500/50" />
        <div className="h-3 w-3 rounded-full bg-yellow-500/50" />
        <div className="h-3 w-3 rounded-full bg-green-500/50" />
        <span className="ml-2 text-gray-400 text-xs">create-link.ts</span>
      </div>
