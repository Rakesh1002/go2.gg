      ...
      <section className="max-w-7xl px-4 py-16 md:py-24">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <h1 className="font-bold text-4xl text-[var(--marketing-text)] tracking-tight md:text-6xl">
            Links Built for
            <span className="mt-2 block text-gradient">SMS Marketing</span>
          </h1>
            ...
            <div className="rounded-xl border border-[var(--marketing-border)] bg-[var(--marketing-bg-elevated)] p-6 shadow-xl">
              <div className="space-y-4">
                ...
                <div className="rounded-lg bg-[var(--marketing-bg-elevated)] p-4 font-mono text-sm">
                  <div className="mb-2 text-[var(--marketing-text-muted)]">Your message:</div>
                  <div className="text-[var(--marketing-text)]">
                    Check out our new product! go2.gg/abcd
                  </div>
                  <div className="mt-4 flex items-center justify-between text-[var(--marketing-text-muted)] text-xs">
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-3">
                  <div className="flex items-center justify-between rounded-lg bg-[var(--marketing-bg-elevated)] p-3">
                    <span className="text-[var(--marketing-text)] text-sm">
                      Single segment (GSM-7)
                    </span>
                    <span className="font-mono font-semibold text-[var(--marketing-text)] text-sm">
                      160 chars
                    </span>
                  </div>
                  <div className="flex items-center justify-between rounded-lg bg-[var(--marketing-bg-elevated)] p-3">
