...
import { Search, MoreHorizontal, Eye, Trash2, Users, ExternalLink, } from "lucide-react";
    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-4 md:grid-cols-3">
        <Card>
          ...
          <CardContent>
            <div className="font-bold text-2xl">{orgs.length}</div>
          </CardContent>
        </Card>
        <Card>
          <CardHeader className="pb-2">
        ...
        <Card>
          <CardHeader className="pb-2">
            <CardTitle className="font-medium text-muted-foreground text-sm">Total MRR</CardTitle>
          </CardHeader>
          <CardContent>
            <div className="font-bold text-2xl">${totalMRR.toLocaleString()}</div>
          </CardContent>
        </Card>
      </div>
