        ...
        <Card className="cursor-pointer hover:bg-muted/50">
          <CardContent className="flex items-center gap-4 pt-6">
            ...
            <div>
              ...
              <p className="text-muted-foreground text-sm">View, edit, and ban users</p>
            </div>
          </CardContent>
        </Card>
        <Card className="cursor-pointer hover:bg-muted/50">
          <CardContent className="flex items-center gap-4 pt-6">
            ...
            <div>
              ...
              <p className="text-muted-foreground text-sm">View and manage organizations</p>
            </div>
          </CardContent>
        </Card>
        <Card className="cursor-pointer hover:bg-muted/50">
          <CardContent className="flex items-center gap-4 pt-6">
            ...
            <div>
              ...
              <p className="text-muted-foreground text-sm">View billing and revenue</p>
            </div>
          </CardContent>
        </Card>
      </div>
