...
export function BottomNav() {
  ...
  return (
    <nav className="fixed right-0 bottom-0 left-0 z-50 border-[var(--dashboard-border)] border-t bg-[var(--dashboard-bg)] md:hidden">
              ...
              {quickActions.map((action) => {
                ...
                return (
                  <Link
                    key={action.href}
                    href={action.href}
                    className="flex items-center gap-3 rounded-lg px-3 py-2.5 font-medium text-foreground text-sm transition-colors hover:bg-accent"
                  >
        ...
        <Popover>
          ...
          <PopoverContent side="top" align="end" className="w-56 p-2" sideOffset={8}>
            <div className="space-y-1">
              ...
              <div className="my-1 border-[var(--dashboard-border)] border-t" />
              <button
                type="button"
