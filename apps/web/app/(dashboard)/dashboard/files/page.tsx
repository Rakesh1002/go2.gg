...
async function FilesHeader() {
  ...
  return (
    <div>
      <h1 className="font-bold text-3xl">Files</h1>
        ...
        <div className="space-y-4">
          <Card>
            ...
            <CardContent className="space-y-4">
              <div className="space-y-2">
                ...
                <p className="text-muted-foreground text-xs">Storage included with your plan</p>
              </div>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent className="space-y-2">
              <p className="text-muted-foreground text-sm">Access your files programmatically:</p>
