  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="font-bold text-2xl">Import Links</h1>
              ...
              >
                ...
                {file ? (
                  ...
                  <div className="text-center">
                    ...
                    <p className="text-muted-foreground text-sm">or drag and drop your CSV file</p>
                  </div>
                )}
              </label>

              <div className="space-y-2">
                <label htmlFor={formatLabelId} className="font-medium text-sm">
                  Import Format
                </label>
              ...
              {capabilities.canAddFolder && (
                <div className="space-y-2">
                  ...
                  <FolderPicker
                    ...
                    includeNone={false}
                    placeholder="No folder (links land at root)"
                  />
                  <p className="text-muted-foreground text-xs">
                    All imported links will be assigned to this folder.
                  </p>
                </div>
              )}
          ...
          <div className="grid gap-4 md:grid-cols-4">
            <Card>
              <CardContent className="pt-6">
                <div className="font-bold text-2xl">{preview.preview.total}</div>
                <p className="text-muted-foreground text-sm">Total Links</p>
              </CardContent>
            </Card>
            <Card>
              <CardContent className="pt-6">
                <div className="font-bold text-2xl text-green-600">{preview.preview.valid}</div>
                <p className="text-muted-foreground text-sm">Valid</p>
              </CardContent>
            </Card>
            <Card>
              <CardContent className="pt-6">
                <div className="font-bold text-2xl text-red-600">{preview.preview.invalid}</div>
            ...
            <Card>
              <CardContent className="pt-6">
                ...
                <p className="mt-1 text-muted-foreground text-sm">Detected Format</p>
              </CardContent>
            </Card>
          </div>
        ...
        <Card>
          <CardContent className="py-12">
            <div className="mx-auto max-w-md text-center">
              ...
              <h3 className="mt-4 font-semibold text-lg">Importing Links...</h3>
              <p className="text-muted-foreground">Please wait while we import your links</p>
              <Progress value={importProgress} className="mt-4" />
              <p className="mt-2 text-muted-foreground text-sm">{importProgress}% complete</p>
            </div>
          </CardContent>
        </Card>
      )}
      ...
      {step === "complete" && result && (
        <div className="space-y-6">
          ...
          <div className="grid gap-4 md:grid-cols-2">
            <Card>
              <CardContent className="pt-6">
                <div className="font-bold text-3xl text-green-600">{result.imported}</div>
                <p className="text-muted-foreground">Links Imported</p>
              </CardContent>
            </Card>
            <Card>
              <CardContent className="pt-6">
                <div className="font-bold text-3xl text-red-600">{result.failed}</div>
