    ...
    <>
      ...
      <div className="grid gap-4 md:grid-cols-3">
        <Card>
          ...
          <CardContent>
            <p className="text-muted-foreground text-xs">Active retargeting on these links</p>
          </CardContent>
        </Card>
        <Card>
          <CardHeader className="pb-2">
          ...
          <CardContent>
            <p className="text-muted-foreground text-xs">Across all your links</p>
          </CardContent>
        </Card>
        <Card>
          <CardHeader className="pb-2">
          ...
          <CardContent>
            <p className="text-muted-foreground text-xs">Links with consent banners</p>
          </CardContent>
        </Card>
      </div>
      ...
      {linksWithPixels.length > 0 && (
        <div className="space-y-4">
          <h2 className="font-semibold text-lg">Links with Pixels</h2>
      ...
      {filteredLinks.length === 0 && (
        <div className="py-12 text-center">
          ...
          <h3 className="mt-4 font-semibold text-lg">No links found</h3>
        ...
        <div className="min-w-0">
          ...
          <div className="mt-1 flex items-center gap-2">
            {hasPixels ? (
              ...
              <span className="text-muted-foreground text-xs">No pixels configured</span>
            )}
          </div>
        </div>
      </div>
