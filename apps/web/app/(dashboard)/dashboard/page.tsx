...
import { Globe, BarChart3, QrCode, Plus, } from "lucide-react";
          ...
          <CardContent>
            <div className="grid gap-4 sm:grid-cols-2">
              <a
                ...
                className="group stagger-1 flex animate-fade-in-up items-center gap-4 rounded-xl border border-primary/20 bg-primary/5 p-4 outline-none transition-all duration-300 hover:border-primary/40 hover:bg-primary/10 focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2"
                style={{ animationFillMode: "forwards" }}
              >
                <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-gradient-to-br from-primary to-primary/80 text-white shadow-md shadow-primary/10 transition-all duration-300 group-hover:scale-110 group-hover:shadow-lg">
                  <Plus className="h-6 w-6" />
                </div>
                <div>
                  <p className="font-bold text-primary">Create New Link</p>
                  <p className="text-muted-foreground text-sm">Shorten a URL</p>
                </div>
              </a>
              <a
                href="/dashboard/analytics"
                className="group stagger-2 flex animate-fade-in-up items-center gap-4 rounded-xl border border-border/50 p-4 outline-none transition-all duration-300 hover:border-violet-500/40 hover:bg-violet-500/5 focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2"
                style={{ animationFillMode: "forwards" }}
              >
                <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-violet-500/10 text-violet-600 transition-all duration-300 group-hover:scale-110 group-hover:bg-violet-500 group-hover:text-white dark:text-violet-400">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground text-sm">Track your clicks</p>
                </div>
              </a>
              <a
                href="/dashboard/domains"
                className="group stagger-3 flex animate-fade-in-up items-center gap-4 rounded-xl border border-border/50 p-4 outline-none transition-all duration-300 hover:border-primary/40 hover:bg-primary/5 focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2"
                style={{ animationFillMode: "forwards" }}
              >
                ...
                <div>
                  ...
                  <p className="text-muted-foreground text-sm">Use your own domain</p>
                </div>
              </a>
              <a
                href="/dashboard/links?qr=true"
                className="group stagger-4 flex animate-fade-in-up items-center gap-4 rounded-xl border border-border/50 p-4 outline-none transition-all duration-300 hover:border-primary/40 hover:bg-primary/5 focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2"
                style={{ animationFillMode: "forwards" }}
              >
                <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-primary/10 text-primary transition-all duration-300 group-hover:scale-110 group-hover:bg-primary group-hover:text-white">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground text-sm">For your links</p>
                </div>
              </a>
            </div>
          </CardContent>
...
function RecentActivity() {
  // Server-side fetch was unconditionally skipped in production to avoid
  // worker-to-worker 522s, which left the panel showing "No links yet" for
  // every user. The client variant fetches via SWR and shows real data.
  return <RecentActivityClient />;
}
