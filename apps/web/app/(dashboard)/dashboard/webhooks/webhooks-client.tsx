...
const WEBHOOK_EVENTS = [
  { id: "click", label: "Link Click", description: "Fires on every click — bot or human" },
  {
    id: "conversion",
    label: "Conversion",
    description: "Fires when a tracked conversion is recorded (lead, sale, signup)",
  },
            ...
            <form onSubmit={handleSubmit(onCreateWebhook)}>
              ...
              <div className="space-y-4 py-4">
                ...
                <div>
                  ...
                  />
                  {errors.url && (
                    <p className="mt-1 text-destructive text-sm">{errors.url.message}</p>
                  )}
                </div>
                <div>
                  ...
                  {selectedEvents.length === 0 && (
                    <p className="mt-1 text-destructive text-sm">Select at least one event</p>
                  )}
                </div>
              </div>
              <DialogFooter>
