    ...
    <div className="space-y-6">
      ...
      <div>
        <div className="flex items-center gap-2">
          <h2 className="font-bold text-2xl tracking-tight">AI Slug Generator</h2>
            ...
            <div className="space-y-3 pt-4">
              ...
              {suggestions.map((suggestion, index) => (
                <div
                  ...
                  className="flex items-center justify-between gap-4 rounded-lg border p-4 transition-colors hover:border-primary/50 hover:bg-muted/50"
                >
                  <div className="flex min-w-0 items-center gap-3">
                    ...
                    <div className="min-w-0">
                      <p className="font-medium font-mono text-lg">/{suggestion.slug}</p>
                      <p className="truncate text-muted-foreground text-sm">{suggestion.reason}</p>
                    </div>
                  </div>
        ...
        <CardContent>
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
            ...
            <div className="space-y-1">
              ...
              <p className="text-muted-foreground text-xs">Use words that relate to your content</p>
            </div>
            <div className="space-y-1">
